...
TeWindow("TeWindow").TeScreen("Si").TeField("Password").SetSecure "6040ab861fc184aa25fcb7e5584247df" @@ hightlight id_;_826_;_script infofile_;_ZIP::ssf2.xml_;_
...
TeWindow("TeWindow").TeScreen("ACCOUNT FILE: RECORD CHANGE").TeField("DATE ISSUED").Set "06" @@ hightlight id_;_922_;_script infofile_;_ZIP::ssf12.xml_;_
...
TeWindow("TeWindow").InsightObject("InsightObject_2").Click @@ hightlight id_;_10_;_script infofile_;_ZIP::ssf17.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_3").Click @@ hightlight id_;_23_;_script infofile_;_ZIP::ssf18.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_4").Click @@ hightlight id_;_30_;_script infofile_;_ZIP::ssf19.xml_;_
TeWindow("TeWindow").InsightObject("InsightObject_5").Click @@ hightlight id_;_35_;_script infofile_;_ZIP::ssf20.xml_;_
